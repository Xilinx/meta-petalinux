...
IMAGE_INSTALL:append:zynqmp = " ${VITISAI_DEPENDENCIES} xrt openamp-demo-notebooks watchdog-init hellopm cppzmq-dev jansson packagegroup-petalinux-som kernel-devsrc kernel-module-dp mosquitto"
...
IMAGE_INSTALL:append:versal = " ${VITISAI_DEPENDENCIES} xrt openamp-demo-notebooks kernel-devsrc"
