...
# kernel-module-dp kernel-module-hdmi
IMAGE_INSTALL:append:zynqmp = " ${VITISAI_DEPENDENCIES} xrt cppzmq-dev jansson kernel-devsrc mosquitto kernel-module-hdmi21"
