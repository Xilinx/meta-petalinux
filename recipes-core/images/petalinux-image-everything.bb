...
IMAGE_INSTALL:append:zynqmp = " ${VITISAI_DEPENDENCIES} cppzmq-dev jansson kernel-devsrc mosquitto kernel-module-dp kernel-module-hdmi21"
...
IMAGE_INSTALL:append:versal = " ${VITISAI_DEPENDENCIES} kernel-devsrc pm-notebooks kernel-module-hdmi21"
IMAGE_INSTALL:append:versal = "${@bb.utils.contains('DISTRO_FEATURES', 'openamp', ' openamp-demo-notebooks', '', d)}"

IMAGE_INSTALL:append:versal-net = " ${VITISAI_DEPENDENCIES} kernel-devsrc pm-notebooks"
