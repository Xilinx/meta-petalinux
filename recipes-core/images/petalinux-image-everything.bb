...
IMAGE_INSTALL:append:zynqmp = " ${VITISAI_DEPENDENCIES} xrt watchdog-init hellopm cppzmq-dev jansson kernel-devsrc mosquitto kernel-module-dp"
#IMAGE_INSTALL:append:zynqmp = " kernel-module-hdmi"
